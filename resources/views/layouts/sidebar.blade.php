...
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" href="{{ route('user.index') }}" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">--}}
{{--                                        index--}}
{{--                                    </a>--}}
{{--                                    <div id="submenu-1-2" class="collapse submenu">--}}
{{--                                        <ul class="nav flex-column">--}}
{{--                                            <li class="nav-item">--}}
{{--                                                <a class="nav-link" href="{{ route('user.create') }}">E Commerce Dashboard</a>--}}
{{--                                            </li>--}}
{{--                                            <li class="nav-item">--}}
...
{{--                    </li>--}}
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.index') }}" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">
                            <i class="fa fa-fw fa-rocket"></i>UI Elements
                        </a>
                        <div id="submenu-2" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('user.create') }}">Cards <span class="badge badge-secondary">New</span></a>
                                </li>
{{--                                <li class="nav-item">--}}
